...
export function Login() {
  ...
  const resetForgot = () => { setShowForgot(false); setForgotSent(false); setForgotError(''); setForgotEmail(''); };
          ...
          <>
            ...
            {forgotSent ? (
              <div className="text-center py-4">
                ...
                <button type="button" onClick={resetForgot} className="mt-6 text-sm text-accent hover:underline">
                  Back to sign in
                </button>
              </div>
            ) : (
