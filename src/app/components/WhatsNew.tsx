...
export const RELEASES: Release[] = [
  {
    ...
    highlights: [
      ...
      'Game search is smarter: fuzzy matching handles typos, and parent games rank above their expansions and remasters',
      'Remasters, remakes, and expanded games now appear correctly and are linked together',
      'Game detail pages load faster and no longer re-fetch data upon reload',
      'Profile avatars no longer flash or pop in; photos fade in smoothly',
      'Feed skeleton loader layout updated to mirror the actual page structure',
