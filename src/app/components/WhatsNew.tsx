...
export const RELEASES: Release[] = [
  {
    ...
    highlights: [
      'Google Sign-In now works on Android — sign up or log in with your Google account',
      'Game search is smarter: fuzzy matching handles typos, and parent games (e.g. World of Warcraft) rank above their expansions and remasters',
      'Remasters, remakes, and expanded games now appear correctly under their parent game — WoW Classic, Burning Crusade, and more link back to the original',
      'Game detail pages load faster and no longer re-fetch data when navigating back',
      'Profile avatars no longer flash or pop in — your photo fades in smoothly over your initials everywhere it appears',
