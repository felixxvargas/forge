...
const interestOptions: { category: string; icon: any; interests: Interest[] }[] = [
  ...
  },
  {
    ...
    interests: [
      ...
      { id: 'metroidvania', label: 'Metroidvania', category: 'genre' },
      { id: 'battle-royale', label: 'Battle Royale', category: 'genre' },
      { id: 'mmo', label: 'MMO', category: 'genre' },
      { id: 'card-game', label: 'Card Game', category: 'genre' },
      { id: 'rhythm', label: 'Rhythm', category: 'genre' },
      { id: 'vr', label: 'VR', category: 'genre' },
      { id: 'visual-novel', label: 'Visual Novel', category: 'genre' },
      { id: 'sandbox', label: 'Sandbox', category: 'genre' },
      { id: 'tower-defense', label: 'Tower Defense', category: 'genre' },
    ]
  },
  {
    category: 'Playstyle',
    ...
    interests: [
      ...
      { id: 'pvp', label: 'PvP', category: 'playstyle' },
      { id: 'pve', label: 'PvE', category: 'playstyle' },
      { id: 'speedrun', label: 'Speedrunning', category: 'playstyle' },
      { id: 'collector', label: 'Completionist', category: 'playstyle' },
      { id: 'streamer', label: 'Streaming / Content Creator', category: 'playstyle' },
      ...
      { id: 'hardcore', label: 'Hardcore', category: 'playstyle' },
      { id: 'min-max', label: 'Min-Maxer', category: 'playstyle' },
      { id: 'grinder', label: 'Grinder', category: 'playstyle' },
      { id: 'explorer', label: 'Explorer', category: 'playstyle' },
      { id: 'roleplay', label: 'Roleplayer', category: 'playstyle' },
      { id: 'modder', label: 'Modder', category: 'playstyle' },
      { id: 'early-access', label: 'Early Access Fan', category: 'playstyle' },
      { id: 'retro', label: 'Retro Gaming', category: 'playstyle' },
    ]
  }
];
