-- Add game_wiki_entity_edits and game_wiki_entity_edit_votes cleanup to delete_user_account
...
BEGIN
  ...
  DELETE FROM public.game_wiki_entity_edit_votes  WHERE user_id = _uid;
  DELETE FROM public.game_wiki_entity_edits       WHERE user_id = _uid;
